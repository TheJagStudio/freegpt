...
const ScrollArea = React.forwardRef(({ className, children, id, ...props }, ref) => (
    <ScrollAreaPrimitive.Root ref={ref} className={cn("relative overflow-hidden", className)} {...props}>
        <ScrollAreaPrimitive.Viewport id={id} className="h-full w-full rounded-[inherit] scroll-smooth">
            {children}
